        ...
        <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
            <div className="flex flex-col lg:flex-row justify-between gap-8">
                <div className="w-full lg:w-5/12 flex flex-col justify-center">
                    ...
                    <p className="font-normal text-base leading-6 text-gray-600 ">We are the team of four people had started this bussiness.Because the price of new book is comparatively high in market and other thing is most of the time people read the books one or two times only then  what they do with it nothing.But now it is giving the best opportuinity we made that a person can sell his/her book very easily.Our team is very dedicated so that we can make a great website for you with great user interface and you can sell and buy your old book very easily.</p>
                </div>
