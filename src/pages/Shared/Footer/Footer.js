...
const Footer = () => {
    return (
        <div className='mt-10 mx-auto bg-gray-800'>
            
        <footer className="p-4 text-white sm:p-6 dark:bg-gray-900 w-8/12 mx-auto">
            <div className="md:flex md:justify-between">
                <div className="mb-6 md:mb-0">
                    <a href="https://flowbite.com/" className="flex items-center">
                        <img src={logo} className="mr-3 h-8" alt="FlowBite Logo" />
                        <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Bookish Hero</span>
                    </a>
                </div>
                <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    <div>
                        ...
                        <ul className="text-white dark:text-white">
                            <li className="mb-4">
                                <a href="https://flowbite.com/" className="hover:underline">Book</a>
                            </li>
                            <li>
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
                <span className="text-sm text-white sm:text-center dark:text-white-400">© 2022 <a href="https://flowbite.com/" className="hover:underline">Bookish Hero™</a>. All Rights Reserved.
                </span>
                <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                    <a href="#" className="text-white hover:text-white-900 dark:hover:text-white">
