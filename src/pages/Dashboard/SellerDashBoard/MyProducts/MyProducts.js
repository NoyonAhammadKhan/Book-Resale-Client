...
const MyProducts = () => {
    ...
    const {productName,productCondition,productLocation,resalePrice,originalPrice,usedYear,status,advertise}=sellerProducts;
